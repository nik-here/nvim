...
vim.keymap.set("n", "<ALT+5>", function()
	ui.nav_file(5)
end)
vim.keymap.set("n", "<ALT+6>", function()
	ui.nav_file(6)
end)
vim.keymap.set("n", "<ALT+7>", function()
	ui.nav_file(7)
end)
vim.keymap.set("n", "<ALT+8>", function()
	ui.nav_file(8)
end)
vim.keymap.set("n", "<ALT+9>", function()
	ui.nav_file(9)
end)
